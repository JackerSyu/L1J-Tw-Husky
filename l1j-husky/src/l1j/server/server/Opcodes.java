...
public class Opcodes {
	 ...
	 */
		...
		/** Client Packet */
	   public static final int C_OPCODE_DUNGEONTELEPORT = 0;
	    public static final int C_OPCODE_ADDBOOKMARK = 1; // 請求增加記憶座標
	    public static final int C_OPCODE_DEPOSIT = 2; // 請求將資金存入城堡寶庫
	    public static final int C_OPCODE_CALL = 3; // 請求傳送至指定的外掛使用者身旁
	    public static final int C_OPCODE_BANCLAN = 4; // 請求驅逐血盟成員
	    public static final int C_OPCODE_BOARDDELETE = 5; //// 請求刪除公佈欄內容
	    public static final int C_OPCODE_BOARDREAD = 6; // 請求閱讀佈告單個欄訊息
	    public static final int C_OPCODE_LEAVEPARTY = 7; // 請求退出隊伍
	    public static final int C_OPCODE_BOARDBACK = 8;  // 請求查看下一頁佈告欄的訊息
	    public static final int C_OPCODE_ARROWATTACK = 11; // 請求使用遠距攻擊
	    public static final int C_OPCODE_USEITEM = 12; // 請求使用物品
	    public static final int C_OPCODE_RESULT = 13; // 請求取得列表中的項目
	    public static final int C_OPCODE_FIGHT = 14; // 請求決鬥
	    public static final int C_OPCODE_SELECTWARTIME = 15; //要求選擇 變更攻城時間(but3.3C無使用)
	    public static final int C_OPCODE_BANPARTY = 18; // 請求驅逐隊伍
	    public static final int C_OPCODE_CHANGEWARTIME = 20; //修正城堡總管全部功能
	    public static final int C_OPCODE_TRADEADDITEM = 21; // 請求交易(添加物品)
	    public static final int C_OPCODE_PUTHIRESOLDIER = 23; // 請求退出觀看模式
	    public static final int C_OPCODE_EXIT_GHOST = 24; // 請求退出觀看模式
	    public static final int C_OPCODE_TRADE = 27; // 請求交易
	    public static final int C_OPCODE_TITLE = 28; // 請求賦予封號
	    public static final int C_OPCODE_DOOR = 29; // 請求開門或關門
	    public static final int C_OPCODE_ENTERPORTAL = 31; // 請求傳送 (進入地監)
	    public static final int C_OPCODE_SKILLBUY = 32; // 請求查詢可以學習的魔法清單
	    public static final int C_OPCODE_HIRESOLDIER = 33; //要求僱傭傭兵列表(購買)
	    public static final int C_OPCODE_SKILLBUYITEM = 34; // 請求結婚
	    public static final int C_OPCODE_PROPOSE = 35; // 請求結婚
	    ...
	    public static final int C_OPCODE_SKILLBUYOKITEM = 44; //要求血盟數據(例如盟標)**[未抓取]
	    public static final int C_OPCODE_CLAN = 45; //要求血盟數據(例如盟標)**[未抓取]
	    public static final int C_OPCODE_BOOKMARKDELETE = 46; // 請求刪除記憶座標
	    public static final int C_OPCODE_MOVECHAR = 47; // 請求移動角色
	    public static final int C_OPCODE_BUDDYLIST = 48; // 請求查詢好友名單
	    public static final int C_OPCODE_RESTART = 49; // 請求重新開始
	    public static final int C_OPCODE_SETCASTLESECURITY = 51;
	    public static final int C_OPCODE_COMMONCLICK2 = 53;
	    public static final int C_OPCODE_TRADEADDOK = 54; // 請求完成交易
	    public static final int C_OPCODE_SMS = 55; // 請求傳送簡訊
	    public static final int C_OPCODE_DELETEINVENTORYITEM = 56; // 請求刪除物品
	    public static final int C_OPCODE_NEWCHAR = 57; // 請求創造角色
	    public static final int C_OPCODE_CHARACTERCONFIG = 59; // 請求紀錄快速鍵
	    public static final int C_OPCODE_RETURNTOLOGIN = 60; //要求回到選人畫面
	    public static final int C_OPCODE_SELECTLIST = 62; // 請求修理道具
	    public static final int C_OPCODE_PARTYLIST = 63; // 請求查詢隊伍成員
	    public static final int C_OPCODE_CASTLESECURITY = 64; // 請求管理城內治安
	    public static final int C_OPCODE_LOGINTOSERVER = 65; // 請求登錄角色
	    public static final int C_OPCODE_CHANGECHAR = 66; // 請求切換角色
	    public static final int C_OPCODE_CREATENEWACC = 67; 
	    public static final int C_OPCODE_AUTOLOGIN = 68;
	    public static final int C_OPCODE_KEEPALIVE = 69; // 請求更新連線狀態
	    public static final int C_OPCODE_WAREHOUSELOCK = 70; // 請求變更倉庫密碼 && 送出倉庫密碼
	    public static final int C_OPCODE_DRAWAL = 71; // 請求領取城堡寶庫資金
	    public static final int C_OPCODE_AMOUNT = 72; // 請求傳回選取的數量
	    public static final int C_OPCODE_ADDBUDDY = 73; // 請求新增好友
	    public static final int C_OPCODE_NPCACTION = 74; // 請求執行對話視窗的動作
	    public static final int C_OPCODE_WHO = 75; // 請求查詢遊戲人數
	    public static final int C_OPCODE_SKILLBUYOK = 76; // 請求學習魔法
	    public static final int C_OPCODE_TELEPORT = 77; // 請求解除傳送鎖定
	    public static final int C_OPCODE_FISHCLICK = 78; // 請求釣魚收竿
	    public static final int C_OPCODE_ATTACK = 79; // 請求攻擊對象
	    public static final int C_OPCODE_AUTHLOGIN = 80; // 請求登錄伺服器
	    public static final int C_OPCODE_TAXRATE = 81; // 請求配置稅收
	    public static final int C_OPCODE_LOGINTOSERVEROK = 83; // 請求配置角色設定
	    public static final int C_OPCODE_PLEDGE = 84; // 請求查詢血盟成員
	    public static final int C_OPCODE_PETMENU = 85; // 請求寵物回報選單
	    public static final int C_OPCODE_PUTBOWSOLDIER = 86; //要求配置城牆上弓手
	    public static final int C_OPCODE_NPCTALK = 87; // 請求對話視窗
	    public static final int C_OPCODE_CLIENTVERSION = 89; // 請求驗證客戶端版本
	    public static final int C_OPCODE_MAIL = 90; // 請求打開郵箱
	    public static final int C_OPCODE_FIX_WEAPON_LIST = 91; // 請求查詢損壞的道具
	    public static final int C_OPCODE_COMMONCLICK = 92; // 請求下一步 (伺服器公告)
	    public static final int C_OPCODE_SELECTTARGET = 94; // 請求攻擊指定物件(寵物&召喚)
	    public static final int C_OPCODE_DROPITEM = 95; // 請求丟棄物品
	    public static final int C_OPCODE_TRADEADDCANCEL = 96; // 請求取消交易
	    public static final int C_OPCODE_USESKILL = 98; // 請求使用技能
	    public static final int C_OPCODE_QUITGAME = 99; // 請求離開遊戲
	    public static final int C_OPCODE_CHECKPK = 100; // 請求查詢PK次數
	    public static final int C_OPCODE_RANK = 101; // 請求給予角色血盟階級
	    public static final int C_OPCODE_WAR = 102; // 請求宣戰
	    public static final int C_OPCODE_TELEPORTLOCK = 103; // 玩家傳送鎖定(回溯檢測用)
	    public static final int C_OPCODE_CHATGLOBAL = 104; // 請求使用廣播聊天頻道
	    public static final int C_OPCODE_LEAVECLANE = 105; // 請求離開血盟
	    public static final int C_OPCODE_BOARD = 106; // 請求瀏覽公佈欄
	    public static final int C_OPCODE_CHATWHISPER = 108; // 請求使用密語聊天頻道
	    public static final int C_OPCODE_JOINCLAN = 109; // 請求加入血盟
	    public static final int C_OPCODE_DELETECHAR = 111; // 請求刪除角色
	    public static final int C_OPCODE_EXTCOMMAND = 112; // 請求角色表情動作
	    public static final int C_OPCODE_CREATECLAN = 115; // 請求創立血盟
	    public static final int C_OPCODE_EXCLUDE = 117; // 請求使用拒絕名單(開啟指定人物訊息)
	    public static final int C_OPCODE_PRIVATESHOPLIST = 120; // 請求購買指定的個人商店商品
	    public static final int C_OPCODE_PICKUPITEM = 121; // 請求拾取物品
	    public static final int C_OPCODE_PUTSOLDIER = 123; //要求配置已僱用士兵
	    public static final int C_OPCODE_CHARRESET = 124; // 要求重置人物點數
	    public static final int C_OPCODE_SHIP = 125; // 請求下船
	    public static final int C_OPCODE_GIVEITEM = 126; // 請求給予物品
	    public static final int C_OPCODE_BOARDWRITE = 128; // 請求撰寫新的佈告欄訊息
	    ...
	    public static final int S_OPCODE_DELETEINVENTORYITEM = 3; // 刪除物品
	    public static final int S_OPCODE_LOGINTOGAME = 4; // 進入遊戲
	    public static final int S_OPCODE_DETELECHAROK = 5; // 角色移除 (立即或非立即)
	    public static final int S_OPCODE_EMBLEM = 6; // 下載血盟徽章
	    public static final int S_OPCODE_RESURRECTION = 7; // 將死亡的對象復活
	    public static final int S_OPCODE_DUNGEONTELEPORT = 8; 
	    public static final int S_OPCODE_BOARDREAD = 9; // 佈告欄(訊息閱讀)
	    ...
	    public static final int S_OPCODE_INVIS = 11; // 物件隱形或現形
	    public static final int S_OPCODE_CHARAMOUNT = 12; // 角色列表
	    public static final int S_OPCODE_NORMALCHAT = 13; // 一般聊天或大喊聊天頻道
	    public static final int S_OPCODE_DEXUP = 14; // 敏捷提升封包
	    public static final int S_OPCODE_LAWFUL = 15; // 正義值更新
	    public static final int S_OPCODE_TELEPORT = 16; // 傳送術或瞬間移動卷軸-傳送鎖定
	    public static final int S_OPCODE_SERVERMSG = 17; // 系統訊息
	    public static final int S_OPCODE_MOVEOBJECT = 18; // 移動物件
	    public static final int S_OPCODE_DEPOSIT = 19; // 存入資金城堡寶庫
	    public static final int S_OPCODE_WARTIME = 20; // 設定圍成時間
	    public static final int S_OPCODE_DRAWAL = 21; // 領取城堡寶庫資金
	    public static final int S_OPCODE_CURSEBLIND = 22; // 法術效果-暗盲咒術
	    public static final int S_OPCODE_SELECTTARGET = 23; // 選擇一個目標
	    public static final int S_OPCODE_SHOWSHOPSELLLIST = 24; // 商店收購清單
	    public static final int S_OPCODE_PUTSOLDIER = 25; // 配置已的僱用傭兵
	    public static final int S_OPCODE_BLUEMESSAGE = 26; // 紅色訊息
	    public static final int S_OPCODE_TAXRATE = 28; // 設定稅收封包
	    public static final int S_OPCODE_SERVERVERSION = 29; // 伺服器版本
	    public static final int S_OPCODE_CASTLEMASTER = 30; // 角色皇冠
	    public static final int S_OPCODE_SKILLBUY = 31; // 魔法購買 (金幣)
	    public static final int S_OPCODE_POLY = 32; // 改變外型
	    public static final int S_OPCODE_MAIL = 33; // 郵件封包
	    public static final int S_OPCODE_TELEPORTLOCK = 34; // 進入傳送點-傳送鎖定
	    public static final int S_OPCODE_PUTBOWSOLDIERLIST = 35;
	    public static final int S_OPCODE_SKILLBRAVE = 36; // 魔法或物品效果圖示-勇氣藥水類
	    public static final int S_OPCODE_WAR = 37; // 血盟戰爭
	    public static final int S_OPCODE_SELECTLIST = 38; // 損壞武器名單
	    public static final int S_OPCODE_LETTER = 39;
	    public static final int S_OPCODE_SYSMSG = 40; // 伺服器訊息
	    public static final int S_OPCODE_GLOBALCHAT = 40; // 廣播聊天頻道
	    public static final int S_OPCODE_OWNCHARSTATUS = 41; // 角色屬性與能力值
	    public static final int S_OPCODE_EXCEPTION_1 = 42; // 例外事件_1
	    public static final int S_OPCODE_TRADEADDITEM = 43; // 增加交易物品封包
	    public static final int S_OPCODE_DISCONNECT = 44; // 立即中斷連線
	    public static final int S_OPCODE_ITEMAMOUNT = 45; // 物品可用次數
	    public static final int S_OPCODE_ITEMSTATUS = 45; // 物品狀態更新
	    public static final int S_OPCODE_OWNCHARSTATUS2 = 46; // 角色能力值
	    public static final int S_OPCODE_SHOWRETRIEVELIST = 47; // 倉庫物品名單
	    public static final int S_OPCODE_SKILLICONSHIELD = 48; // 魔法效果 : 防禦纇
	    public static final int S_OPCODE_CHARVISUALUPDATE = 49;// 切換物件外觀動作
	    public static final int S_OPCODE_SKILLBUYITEM = 50;
	    public static final int S_OPCODE_HPMETER = 51; // 物件血條
	    public static final int S_OPCODE_ADDSKILL = 52;// 增加魔法進魔法名單
	    public static final int S_OPCODE_SKILLSOUNDGFX = 53;// 產生動畫 [自身]
	    public static final int S_OPCODE_ATTRIBUTE = 54; // 物件屬性
	    public static final int S_OPCODE_RESTART = 55;// 強制重新選擇角色
	    public static final int S_OPCODE_ATTACKPACKET = 56;// 物件攻擊
	    public static final int S_OPCODE_NPCSHOUT = 57;// 一般聊天或大喊聊天頻道
	    public static final int S_OPCODE_INVLIST = 58;// 插入批次道具
	    public static final int S_OPCODE_BLESSOFEVA = 59; // 效果圖示 (水底呼吸)
	    public static final int S_OPCODE_TRADE = 60; // 交易封包
	    public static final int S_OPCODE_ABILITY = 61; // 配置封包
	    public static final int S_OPCODE_NEWCHARWRONG = 62; // 角色創造例外
	    public static final int S_OPCODE_CHARTITLE = 64; // 角色封號
	    public static final int S_OPCODE_WEATHER = 65; // 遊戲天氣
	    public static final int S_OPCODE_RANGESKILLS = 66; // 範圍魔法
	    public static final int S_OPCODE_NEWCHARPACK = 67; // 角色創造成功
	    public static final int S_OPCODE_MATERIAL = 68;  // 魔法學習-材料不足
	    public static final int S_OPCODE_STRUP = 69; // 力量提升封包
	    public static final int S_OPCODE_YES_NO = 70; // 確認視窗
	    public static final int S_OPCODE_MAPID = 71; // 更新現在的地圖
	    public static final int S_OPCODE_EXCEPTION_2 = 72; // 例外事件_2
	    public static final int S_OPCODE_LIGHT = 73; // 物件亮度
	    public static final int S_OPCODE_SOUND = 74; // 撥放音效
	    //public static final int S_OPCODE_PETMENU = 76; // 角色重置
		public static final int S_OPCODE_PETCTRL = 76; // 寵物控制介面移除
	    public static final int S_OPCODE_CHARRESET = 76; // 角色重置
	    public static final int S_OPCODE_SHOWSHOPBUYLIST = 77; // 商店販售清單
	    public static final int S_OPCODE_POISON = 78; // 魔法效果:中毒
	    public static final int S_OPCODE_NEWMASTER = 79;
	    public static final int S_OPCODE_ITEMNAME = 80; // 物品名稱
	    public static final int S_OPCODE_SPOLY = 81; // 特別變身封包
	    public static final int S_OPCODE_CHANGEHEADING = 83; // 物件面向
	    public static final int S_OPCODE_OWNCHARATTRDEF = 84; // 角色屬性值
	    public static final int S_OPCODE_EXP = 85; // 經驗值更新
	    public static final int S_OPCODE_MPUPDATE = 86; // 魔力與最大魔力更新
	    public static final int S_OPCODE_PINKNAME = 87; // 角色名稱變紫色
	    public static final int S_OPCODE_COMMONNEWS = 88; // 公告視窗
	    public static final int S_OPCODE_BOARD = 89; // 佈告欄 (對話視窗)
	    public static final int S_OPCODE_BOOKMARKS = 90; // 插入記憶座標
	    public static final int S_OPCODE_DOACTIONGFX = 91; // 執行物件外觀動作
	    public static final int S_OPCODE_ITEMCOLOR = 92; // 物品屬性狀態
	    public static final int S_OPCODE_GAMETIME = 93; // 更新目前遊戲時間
	    public static final int S_OPCODE_INITPACKET = 95; // 初始化演算法
	    public static final int S_OPCODE_USEMAP = 97;
	    public static final int S_OPCODE_HOUSELIST = 98; // 血盟小屋名單
	    public static final int S_OPCODE_COMMONNEWS2 = 99;// 系統訊息視窗
	    public static final int S_OPCODE_SPMR = 100; // 魔法攻擊力與魔法防禦力
	    public static final int S_OPCODE_ATTACKRANGE = 101;
	    public static final int S_OPCODE_EFFECTLOCATION = 102; // 產生動畫 [座標]
	    public static final int S_OPCODE_CHARLIST = 103; // 角色資訊
	    public static final int S_OPCODE_REDMESSAGE = 104; // 畫面正中出現紅色/新增未使用
	    public static final int S_OPCODE_PINGTIME = 105; // Ping Time
	    public static final int S_OPCODE_PUTHIRESOLDIER = 106; // 配置傭兵
	    public static final int S_OPCODE_IDENTIFYDESC = 107; // 物品資訊訊息
	    public static final int S_OPCODE_DELSKILL = 108; // 移除指定的魔法
	    public static final int S_OPCODE_PRIVATESHOPLIST = 109; // 個人商店販賣或購買
	    public static final int S_OPCODE_LOGINRESULT = 110; // 登入狀態
	    public static final int S_OPCODE_UPDATECLANID = 111;
	    //public static final int S_OPCODE_OBJECTPACK = 112; 
	    public static final int S_OPCODE_CHARPACK = 112; //物件封包
		public static final int S_OPCODE_DROPITEM = 112; // 物件封包 (道具)
	    public static final int S_OPCODE_WHISPERCHAT = 114; // 密語聊天頻道
	    public static final int S_OPCODE_EXCEPTION_3 = 115; // 例外事件_3
	    public static final int S_OPCODE_TRUETARGET = 116; // 法術效果-精準目標
	    public static final int S_OPCODE_LIQUOR = 117; // 海浪波浪
	    public static final int S_OPCODE_PARALYSIS = 118; // 魔法效果 : 麻痺類
	    public static final int S_OPCODE_ITEMCOUNT = 119;
	    public static final int S_OPCODE_CHARGECOUNT = 120;
	    public static final int S_OPCODE_REMOVE_OBJECT = 121; // 物件刪除
	    public static final int S_OPCODE_SKILLHASTE = 122; // 魔法或物品產生的加速效果
	    public static final int S_OPCODE_HPUPDATE = 123; // 體力與最大體力更新
	    public static final int S_OPCODE_HOUSEMAP = 124; // 血盟小屋地圖 [地點]
	    public static final int S_OPCODE_SHOWHTML = 125; // 產生對話視窗
	    //public static final int S_OPCODE_HIRESOLDIERLIST = 126;
	    public static final int S_OPCODE_HIRESOLDIER = 126;
	    public static final int S_OPCODE_CHANGENAME = 127; // 改變物件名稱
