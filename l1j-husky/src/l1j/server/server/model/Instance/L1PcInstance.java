...
import l1j.server.server.model.L1CaoPenaltySkill;
...
import l1j.server.server.model.HealGuard;
	...
	private class Death implements Runnable {
		...
		public void run() {
			...
			if (!isNovice) {
				...
				//add 噴魔法 www.good-lin.com
				int rnd2 = Random.nextInt(1000,1);
				if ((rnd2 <= lostRate) && !IsLostItem) {
					L1CaoPenaltySkill.StartLostSkill(L1PcInstance.this);
				}
				//add 噴魔法 end
			}
